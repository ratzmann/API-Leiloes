// =============================================================================
// __mocks__/leiloeiroRepository.js  -  versao FALSA (mock) usada SO nos testes
// -----------------------------------------------------------------------------
// Quando um teste chama jest.mock('.../leiloeiroRepository.js'), o Jest troca o arquivo
...
module.exports = {
  ...
  buscarPorRegistroProfissional: jest.fn(),
  criar: jest.fn(),
  atualizar: jest.fn(),
  remover: jest.fn(),
};
